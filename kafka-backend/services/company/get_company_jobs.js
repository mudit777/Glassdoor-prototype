...
const handle_request = async (message, callback) => {
    let response = {};
    try {
        let the_query = "SELECT * FROM jobs WHERE company_id = '"+ message.company_id +"'";
        let redis_key = "get_company_jobs_" + message.company_id;
...
// {
//     var query = "SELECT * FROM jobs WHERE company_id = '"+ message.company_id +"'";
